...
M.config = function()
  lvim.builtin.which_key = {
    ...
    mappings = {
      ...
      t = {
        name = "ToggleTerm",
        f = { "<cmd>ToggleTerm direction=float open_mapping=[[<c-\\>]]<cr>", "float" },
        h = {
          name = "horizinal split",
          ["1"] = { "<cmd>ToggleTerm1 direction=horizontal open_mapping=[[<c-\\>]]<cr>", "horizontal" },
          ["2"] = { "<cmd>ToggleTerm2 direction=horizontal open_mapping=[[<c-\\>]]<cr>", "horizontal" },
          ["3"] = { "<cmd>ToggleTerm3 direction=horizontal open_mapping=[[<c-\\>]]<cr>", "horizontal" },
          ["4"] = { "<cmd>ToggleTerm4 direction=horizontal open_mapping=[[<c-\\>]]<cr>", "horizontal" },
        },
        v = {
          name = "vertical split",
