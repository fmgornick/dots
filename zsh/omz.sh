...
# Load all of the plugins in plugins folder
for plugin ("$ZSH"/plugins/*.zsh); do
  _omz_source "plugins/${plugin:t}"
done
_omz_source "plugins/zsh-autosuggestions/zsh-autosuggestions.zsh"
unset plugin
